      ...
      <div className="card shadow-xs border p-3 p-md-4 mb-4">
        <div className="row border-bottom pb-4">
          <div className="col-12 col-md-6 col-lg-2">
            <img className="w-100 rounded-3 mb-3 mb-md-0" src={`${product.images[0].image_url}`} alt={product.description}  />
          </div>
          <div className="col-12 col-md-6 col-lg-5">
            <h5 className="text-base">{product.name}</h5>
            <h6 className="text-sm font-weight-bold">{(Number(product.salgpris_ex_moms) + Number(product.udgående_moms))} kr.</h6>
          ...
          <div className="col-12 col-md-6 col-lg-2 mt-4 mt-lg-0">
            ...
            <p className="text-sm opacity-8">+45 {phoneNumber.toLocaleString()}</p>
          </div>
        </div>
        <div className="mt-4">
          ...
          <div className="d-block d-md-flex justify-content-between">
            <div className="d-block text-center">
              ...
              <p className="font-weight-semibold text-dark">Placed</p>
            </div>
